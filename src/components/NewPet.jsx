      ...
      <div>
        ...
        <form onSubmit={this.handleSubmit} method="POST" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="txt-name" id="txt-name" placeholder="Nombre mascota" onChange={this.onNameChange} required/>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="txt-name">Especie</label>
                    <br/>  
                    <label class="radio-inline"><input type="radio" name="optspecie" id="optspecie1" value="perro" onChange={this.onSpecieDogChange} />   Perro</label>
                    <label class="radio-inline"><input type="radio" name="optspecie" id="optspecie2" value="gato" onChange={this.onSpecieCatChange} />   Gato</label>
                    <label class="radio-inline"><input type="radio" name="optspecie" id="optspecie3" value="otro" onChange={this.onSpecieOtherChange} />   Otro</label>
                </div>
                <div class="form-group col-md-6">
                    <label for="txt-last-name">Raza</label>
                    <select class="form-control" onChange={this.onRaceChange} id="selrace" name="selrace">
            ...
            <div class="form-group">
                ...
                <select class="form-control" onChange={this.onOwnerChange} id="selowner" name="selowner" required>
                    <option value="ninguno">Selecciona una opción</option>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="txt-food" name="txt-food" placeholder="Tipos de comida" onChange={this.onTypeOfFoodChange} required  />
            </div>
            <div class="form-group">
                <label for="txt-cellphone">Enfermedades o alergias</label>
                <textarea class="form-control" rows="5" id="txt-deseases" name="txt-deseases" onChange={this.onDiseasesChange}></textarea>
            </div>
            <div class="form-group">
                <label for="txt-cellphone">Cuidados especiales</label>
                <textarea class="form-control" rows="5" id="txt-cares" name="txt-cares" onChange={this.onCaresChange} ></textarea>
